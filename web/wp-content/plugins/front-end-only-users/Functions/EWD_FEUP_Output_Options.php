...
function EWD_FEUP_Output_Options() {
		...
		elseif ($_GET['Action'] == "EWD_FEUP_Level_Details")  {include( plugin_dir_path( __FILE__ ) . '../html/LevelDetails.php');}
		elseif ($_GET['Action'] == "EWD_FEUP_Statistics_Details")  {include( plugin_dir_path( __FILE__ ) . '../html/StatisticsDetails.php');}
		elseif ($_GET['Action'] == "EWD_FEUP_Payment_Details")  {include( plugin_dir_path( __FILE__ ) . '../html/PaymentDetails.php');}

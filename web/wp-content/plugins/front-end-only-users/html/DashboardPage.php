...
<div id="feup_pro" class="postbox " >
	...
	<div class="inside">
		<ul><li><a href="http://www.etoilewebdesign.com/plugins/front-end-only-users/"><?php _e("Upgrade to the full version ", "EWD_FEUP"); ?></a><?php _e("to take advantage of all the available features of the Front-End Users for Wordpress!", 'EWD_FEUP'); ?></li>
			<?php if (get_option("EWD_FEUP_Trial_Happening") == "Yes") { ?><li><strong>Your trial expires at <?php echo date("Y-m-d H:i:s", get_option("EWD_FEUP_Trial_Expiry_Time")); ?> GMT</strong>, upgrade before then to retain any premium changes made!</li>
				<?php } elseif (!get_option("EWD_FEUP_Trial_Happening")) { ?><li>Want to try out the features first? Use code "EWD Trial" for a 7 day trial!</li><?php } ?>
		</ul>
		<h3 class='hndle'><span><?php _e("What you get by upgrading:", 'EWD_FEUP') ?></span></h3>
			<ul>
				...
				<li>PayPal integration: Ability to charge users a one-time, annual, or monthly membership fee through PayPal.</li>
				<li>Admin approval of users and email confirmation so that you know your user's email addresses exist.</li>
				<li>Statistics: This feature allows you to gather information about frontend users and how they are using your site, as well as to see what pages each user has visited.</li>
		...
		<div id="side-sortables" class="metabox-holder ">
			<div id="feup-upgrade" class="postbox " >
				...
				<div class="inside">
					...
					<?php  if (get_option("EWD_FEUP_Install_Flag") == "Yes") { ?><ul><li><?php _e("Thanks for installing Front-End Only Users.", "EWD_FEUP"); ?><br> <a href='http://www.facebook.com/EtoileWebDesign'><?php _e("Follow us on Facebook", "EWD_FEUP"); ?></a> <?php _e("to suggest new features or hear about upcoming ones!", "EWD_FEUP");?>  </li></ul>
					<?php } else { ?><ul><li><?php _e("Thanks for upgrading to version 3.0.1!", "EWD_FEUP"); ?><br> <a href='https://wordpress.org/support/view/plugin-reviews/front-end-only-users?filter=5'><?php _e("Please rate our plugin", "EWD_FEUP"); ?></a> <?php _e("if you find Front-End Only Users useful!", "EWD_FEUP");?> </li></ul><?php }  ?>
...
<div id="col-full">
<h3 class="ewd-feup-dashboard-h3"><?php _e("Recent User Activity", 'EWD_FEUP'); ?></h3>
...
<div id='ewd-feup-dashboard-leave-review' class='ewd-feup-leave-review postbox upcp-postbox-collapsible'>
...
<div id='ewd-dashboard-updates' class='ewd-feup-updates postbox upcp-postbox-collapsible'>
<h3 class='hndle ewd-feup-dashboard-h3' id='ewd-recent-changes'><?php _e("Recent Changes", 'UPCP'); ?> <i class="fa fa-cog" aria-hidden="true"></i></h3>
<div class='ewd-dashboard-content' ><?php echo get_option('EWD_FEUP_Changelog_Content'); ?></div>
</div>

<div id='ewd-dashboard-blog' class='ewd-feup-blog postbox upcp-postbox-collapsible'>
...
<div id="ewd-dashboard-plugins" class='ewd-feup-plugins postbox upcp-postbox-collapsible' >
	<h3 class='hndle ewd-feup-dashboard-h3'><span><?php _e("Goes great with:", 'UPCP') ?></span><i class="fa fa-plug" aria-hidden="true"></i></h3>
	<div class="inside">

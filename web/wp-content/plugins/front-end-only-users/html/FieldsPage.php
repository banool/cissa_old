...
<div class="form-field">
	...
	<p><?php 
		//_e("The meaning of the field. This field is only necessary if WordPress users are being created using the plugin, or if data is being pulled from Facebook.", 'EWD_FEUP');
		_e("The meaning of the field. This field is only necessary if WordPress users are being created using the plugin.", 'EWD_FEUP')
	?></p>
</div>
